...
class OverlineTabIndicator extends Decoration {
  ...
  Decoration? lerpFrom(Decoration? a, double t) {
    if (a is OverlineTabIndicator) {
      return OverlineTabIndicator(
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _OverlinePainter(this, borderRadius, onChanged);
  }
  ...
  Rect _indicatorRectFor(Rect rect, TextDirection textDirection) {
    ...
    return Rect.fromLTWH(
      ...
      indicator.top,
      indicator.width,
      indicator.top + borderSide.width,
    );
  }
...
class _OverlinePainter extends BoxPainter {
  _OverlinePainter(this.decoration, this.borderRadius, super.onChanged);

  final OverlineTabIndicator decoration;
  final BorderRadius? borderRadius;
